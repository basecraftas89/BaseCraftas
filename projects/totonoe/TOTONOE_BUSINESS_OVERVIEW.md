...
| 名称 | 役割・提供物 | 収益上の役割 | 2026年9月13日現在 |
|---|---|---|---|
| 週末のAI整え習慣 | 毎週土曜6:00〜6:30の無料朝活、Podcast、アーカイブ | 信頼・参加・ニーズ発見 | 公開中。Podcastはローカルデータ上16回。アーカイブはコメキャリ生限定の案内 |
| たより｜TAYORI | 週次資料、短い解説動画、会員Q&A、週1回の優先質問 | 個人月額と将来のTeam月額 | LP公開中、申込は準備中。2026年9月13日に全新規申込みを14日間無料とするWorkerを本番反映済みだが、Checkout自体は停止中 |
...
| いろは｜IROHA | AIリテラシー、ツール別活用、週間学習計画、実績と振り返り | 入会金＋月額継続課金 | 公開ナビで準備中。URLはサービス一覧へ転送。UI・データ設計・テスト決済のローカル基盤あり |
...
|---|---|---|---|
| TAYORI 一般 | 月額1,480円税込、入会金なし、14日間無料 | 低単価の継続接点 | LPは申込準備中。サーバー定義とStripeテスト基盤あり |
| TAYORI 資格確認済みセラピスト | 月額980円税込、入会金なし、14日間無料 | コア対象への継続課金 | 同上 |
| TAYORI Team | 10名5,000円／20名10,000円／50名15,000円／100名25,000円、101名以上は個別相談 | 席数型のチーム売上 | 公開LP上の「現時点の料金案」。申込準備中 |
| IROHA 初回 | 入会金：一般48,000円／資格確認済みセラピスト4,800円。月額は初回30日間無料 | 初期価値とオンボーディング | ローカル定義とStripeサンドボックス。本番販売前 |
| IROHA 継続 | 月額2,980円税込。一般・セラピスト共通 | 学習継続とTAYORIを含むストック収益 | 本番販売前 |
| IROHA 再入会 | 一般28,000円／資格確認済みセラピスト9,800円。無料期間なし | 再開時のオンボーディング | 本番販売前 |
...
| IROHA学習基盤 | 教材、週間計画、進捗、振り返り、資格確認 | D1、制限付きDrive、非公開R2、Worker | UI・スキーマ・一部APIあり。実Drive同期・本番データ・公開導線は未完了 |
...
| ローカル実装 | 会員UI、認証、課金、権限、配信、質問、資格確認、請求サマリのコードとテスト | 本番反映、シークレット、DB移行、外部サービスE2Eは別の完了条件 |
