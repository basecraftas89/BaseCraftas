...
## 2026年9月22日：TOPの4コンテンツ画像を刷新（本番反映済み）
...
- Cloudflare静的WorkerのVersion IDは `f4188002-d4cb-4a3c-a60a-476b85ca1d18`。匿名ブラウザでPC・390px幅の表示とつづり／つまみのタブ切り替えを確認し、公開中の4画像はローカル配信用ファイルとSHA-256が一致した。
