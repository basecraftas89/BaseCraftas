...
| たより｜TAYORI | 週次資料、短い解説動画、会員Q&A、週1回の優先質問 | 個人月額と将来のTeam月額 | 本番に月額980円の職種共通1プラン、14日間無料、初回10名枠、10名単位の管理者追加、ウェイトリストを反映済み。Checkoutは停止中 |
...
|---|---|---|---|
| TAYORI 個人 | 月額980円税込、入会金なし、14日間無料、初回10名 | 低単価の継続接点 | 本番案内・受付枠・ウェイトリスト反映済み。満枠後は管理者が10名単位で開放。決済開始前 |
