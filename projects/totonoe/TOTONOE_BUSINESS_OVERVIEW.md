...
## 2026年9月22日：つまみの固定動画廃止とStudio登録の安定化（本番反映済み・新3件は公開待ち）
...
- 新しいYouTube動画3件（`BMhHEeAj6-I`、`0oVl1m7wBbk`、`ICu95mMyCFg`）は、タイトル・紹介文・タグを付けてStudioの共有下書きへ登録済み。公開は管理者権限が必要で、編集者セッションからの公開は `forbidden` となることを実機確認したため、本番公開待ち。
- 公開中のつまみは確認時点でClaude Academy動画（`rAnUjlcZhW8`）1件。固定動画廃止と新3件の公開状態を分けて扱う。
...
| つまみ｜TSUMAMI | AIの要点を短い動画・PDF・スライドで提供 | 無料集客、試用価値、他サービスへの送客 | 公開中。固定動画3件を廃止し、Studio公開JSONへ一本化済み。新YouTube動画3件は共有下書き登録済み・管理者公開待ち |
