(() => {
  ...
  const profileApi = "/api/column-studio/api/customer/profile";
  ...
  function fillProfile(profile) {
    ...
    document.querySelector("#memberPlanName").textContent = profile.has_curriculum_access ? "カリキュラム会員（Weekly込み）" : "Weekly会員";
  }
