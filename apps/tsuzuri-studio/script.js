(function(){
  ...
  var CONTENT_TARGETS={column:'つづり｜TSUZURI',podcast:'Podcast',video:'学習コンテンツ',archive:'アーカイブ動画',seminar:'セミナー',learning:'学習コンテンツ',weekend:'つづり｜TSUZURI'};
  ...
  function publicArticlePath(post){return '/'+(normalizeType(post.content_type)==='column'?'tsuzuri':'contents')+'/'+post.slug+'.html';}
