(function(){
  ...
  var CONTENT_TARGETS={column:'つづり｜TSUZURI',podcast:'Podcast',video:'ツマミ｜TSUMAMI',archive:'アーカイブ動画',seminar:'セミナー',learning:'ツマミ｜TSUMAMI',weekend:'つづり｜TSUZURI'};
