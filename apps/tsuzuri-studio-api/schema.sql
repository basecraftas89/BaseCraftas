...
CREATE INDEX IF NOT EXISTS idx_analytics_initiatives_occurred_on ON analytics_initiatives(occurred_on DESC, updated_at DESC);
...
-- Limited TAYORI enrollment and prelaunch email waitlists.
...
INSERT OR IGNORE INTO plan_capacity(plan_code, capacity, increment_size) VALUES ('weekly_monthly', 10, 10);
...
CREATE INDEX IF NOT EXISTS idx_plan_capacity_reservations_active ON plan_capacity_reservations(plan_code, status, expires_at);
